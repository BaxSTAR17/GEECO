                ...
                return DefaultTabController(
                  ...
                  child: Column(
                    children: [
                      ...
                      ElevatedButton(
                        onPressed: () {
                          print("Test button pressed, fogg: ${_sheetController.isAttached}");
                          if (_sheetController.isAttached) {
                            print("Test button: Animating to 0.5");
                            _sheetController.animateTo(
                              0.5,
                            ...
                            print("Test button: Controller not attached");
                          }
                        },
                    ...
                    child: Center(
                      child: FittedBox(
                        ...
                        child: Text(
                          ...
                          style: TextStyle(fontSize: 14, fontWeight: FontWeight.bold, color: Colors.blueGrey.shade700),
                        ),
                      ),
                    ),
                  ),
